...
| Nonlinear complexity has practical value | paired school bootstrap, expanded HGB minus expanded logit; thresholds +0.02 AUPRC or +0.03 recall | AUPRC +0.026 (+0.015 to +0.036); recall +0.016 (+0.003 to +0.029) | not robustly supported; keep as a small secondary gain |
